...
export async function updatelist(handles_file: string, oldhandle: string, newhandle: string) {
    try {
        //update handles.txt
...
export async function updateenv(env_file: string, oldhandle: string, newhandle: string) {
    try {
        //update .env
